<script type="text/javascript">
    $(function(){
      ...
      $("#btn_enviar").click(function(){        
        ...
        actualizar_articulo(id, des,modelo,precio,existencia);         
        return false;
      });   
      ...
      <form class="form-horizontal" action="index.php?op=new_cliente" method="POST">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control input-sm" id="txt_precio" name="txt_precio" maxlength="30" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-2">
              <input type="text" class="form-control input-sm" id="txt_existencia" name="txt_existencia" maxlength="20" />
            </div>
          </div>
